try {
  ...
  <defs>
    ...
    var al = __STORYBOOK_API__,
      {
        ...
        addons: Ee,
        combineParameters: sl,
        controlOrMetaKey: cl,
        controlOrMetaSymbol: ul,
        eventMatchesShortcut: ml,
        eventToShortcut: dl,
        experimental_MockUniversalStore: pl,
        experimental_UniversalStore: fl,
        experimental_getStatusStore: ft,
        experimental_getTestProviderStore: yl,
        experimental_requestResponse: bl,
        experimental_useStatusStore: yt,
        experimental_useTestProviderStore: hl,
        experimental_useUniversalStore: Sl,
        internal_checklistStore: gl,
        internal_fullStatusStore: El,
        internal_fullTestProviderStore: Il,
        internal_universalChecklistStore: vl,
        internal_universalStatusStore: Al,
        internal_universalTestProviderStore: xl,
        isMacLike: $l,
        isShortcutTaken: _l,
        keyToSymbol: Rl,
        merge: Tl,
        mockChannel: Cl,
        optionOrAltSymbol: Ol,
        shortcutMatchesShortcut: kl,
        shortcutToAriaKeyshortcuts: wl,
        shortcutToHumanString: Nl,
        types: Fe,
        useAddonState: Ie,
        useArgTypes: Pl,
        useArgs: Dl,
    ...
    A()
    x()
    var ql = __STORYBOOK_ICONS__,
      {
        AccessibilityAltIcon: Vl,
        AccessibilityIcon: gt,
        AccessibilityIgnoredIcon: Yl,
        AddIcon: jl,
        AdminIcon: Wl,
        AlertAltIcon: zl,
        AlertIcon: Kl,
        ...
        AlignRightIcon: Ql,
        AppleIcon: Zl,
        ArrowBottomLeftIcon: Jl,
        ArrowBottomRightIcon: ei,
        ArrowDownIcon: ti,
        ArrowLeftIcon: ai,
        ArrowRightIcon: ri,
        ArrowSolidDownIcon: ni,
        ArrowSolidLeftIcon: oi,
        ArrowSolidRightIcon: li,
        ArrowSolidUpIcon: ii,
        ArrowTopLeftIcon: si,
        ArrowTopRightIcon: ci,
        ArrowUpIcon: ui,
        AzureDevOpsIcon: mi,
        BackIcon: di,
        BasketIcon: pi,
        ...
        BoldIcon: gi,
        BookIcon: Ei,
        BookmarkHollowIcon: Ii,
        BookmarkIcon: vi,
        BottomBarIcon: Ai,
        BottomBarToggleIcon: xi,
        BoxIcon: $i,
        BranchIcon: _i,
        BrowserIcon: Ri,
        BugIcon: Ti,
        ...
        ChevronSmallLeftIcon: Gi,
        ChevronSmallRightIcon: Bi,
        ...
        SideBySideIcon: pu,
        SidebarAltIcon: fu,
        SidebarAltToggleIcon: yu,
        SidebarIcon: bu,
        SidebarToggleIcon: hu,
        SortDownIcon: Su,
        SortUpIcon: gu,
        SpeakerIcon: Eu,
        StackedIcon: Iu,
    ...
    A()
    x()
    var Wm = __STORYBOOK_CORE_EVENTS__,
      {
        ARGTYPES_INFO_REQUEST: zm,
        ARGTYPES_INFO_RESPONSE: Km,
        CHANNEL_CREATED: Xm,
        CHANNEL_WS_DISCONNECT: Qm,
        CONFIG_ERROR: Zm,
        CREATE_NEW_STORYFILE_REQUEST: Jm,
        CREATE_NEW_STORYFILE_RESPONSE: ed,
        CURRENT_STORY_WAS_SET: td,
        DOCS_PREPARED: ad,
        DOCS_RENDERED: rd,
        FILE_COMPONENT_SEARCH_REQUEST: nd,
        FILE_COMPONENT_SEARCH_RESPONSE: od,
        FORCE_REMOUNT: ld,
        FORCE_RE_RENDER: id,
        GLOBALS_UPDATED: sd,
        MANAGER_INERT_ATTRIBUTE_CHANGED: cd,
        NAVIGATE_URL: ud,
        OPEN_IN_EDITOR_REQUEST: md,
        OPEN_IN_EDITOR_RESPONSE: dd,
        PLAY_FUNCTION_THREW_EXCEPTION: pd,
        PRELOAD_ENTRIES: fd,
        PREVIEW_BUILDER_PROGRESS: yd,
        PREVIEW_INITIALIZED: bd,
        PREVIEW_KEYDOWN: hd,
        REGISTER_SUBSCRIPTION: Sd,
        REQUEST_WHATS_NEW_DATA: gd,
        RESET_STORY_ARGS: Ed,
        RESULT_WHATS_NEW_DATA: Id,
        SAVE_STORY_REQUEST: vd,
        ...
        SHARED_STATE_CHANGED: wd,
        SHARED_STATE_SET: Nd,
        STORIES_COLLAPSE_ALL: Pd,
        STORIES_EXPAND_ALL: Dd,
    ...
    var hp = __REACT_DOM__,
      {
        ...
        unstable_renderSubtreeIntoContainer: Rp,
        version: Tp,
      } = __REACT_DOM__
    K()
    K()
    ...
    var $n = w((e, t) => {
        ...
        return (
          k(() => {
            ...
            if (C)
              return (
                C.addEventListener(Be, M),
                () => C.removeEventListener(Be, M)
              )
          }, [M]),
          y(
            An,
